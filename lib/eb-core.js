...
eb.client = {
    ...
    createUO: function(options){
        ...
        this.configure = function(options){
            ...
            if (!this.expert){
                if (!("comenc" in this.keys) || this.keys.comenc === undefined){
                    this.keys.comenc = {key: sjcl.random.randomWords(8)};
                }
                if (!("commac" in this.keys) || this.keys.commac === undefined){
                    this.keys.commac = {key: sjcl.random.randomWords(8)};
                }
                if (!("comnextenc" in this.keys) || this.keys.comnextenc === undefined){
                    this.keys.comnextenc = {key: sjcl.random.randomWords(8)};
                }
                if (!("conextmac" in this.keys) || this.keys.conextmac === undefined){
